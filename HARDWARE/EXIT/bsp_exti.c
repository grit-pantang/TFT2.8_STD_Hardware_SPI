...
static void NVIC_Configuration(void)
{
  ...
  /* 配置中断源：按键1 */
  NVIC_InitStructure.NVIC_IRQChannel = EXTI01_INT_EXTI_IRQ;
  /* 配置抢占优先级 */
  ...
  NVIC_InitStructure.NVIC_IRQChannel = EXTI02_INT_EXTI_IRQ;
  NVIC_Init(&NVIC_InitStructure);
}
...
/*--------------------------KEY1配置-----------------------------*/
  ...
  GPIO_Init(EXTI01_INT_GPIO_PORT, &GPIO_InitStructure);
	...
	/* 选择EXTI的信号源 */
  GPIO_EXTILineConfig(EXTI01_INT_EXTI_PORTSOURCE, EXTI01_INT_EXTI_PINSOURCE); 
  EXTI_InitStructure.EXTI_Line = EXTI01_INT_EXTI_LINE;
