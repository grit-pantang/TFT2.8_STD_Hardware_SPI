...
void DrawTestPage(u8 *str)
{
    ...
    Gui_StrCenter(0, lcddev.height - 18, WHITE, BLUE, "kaysen.yang@foxmail.com", 16, 1); // 居中显示
    // 绘制测试区域
...
void main_test(void)
{
    DrawTestPage("讯铭科技综合测试程序");
    Gui_StrCenter(0, 30, RED, BLUE, "LiangHaoCai", 16, 1);              // 居中显示
    Gui_StrCenter(0, 60, RED, BLUE, "综合测试程序", 16, 1);             // 居中显示
    Gui_StrCenter(0, 90, GREEN, BLUE, "2.8\" ILI9341 240X320", 16, 1);  // 居中显示
    Gui_StrCenter(0, 120, BLUE, BLUE, "13662460324 2019-09-19", 16, 1); // 居中显示
    delay_ms(1500);
    delay_ms(1500);
}
...
void Chinese_Font_test01(void)
{
    ...
    // Show_Str01(32, 56, RED, BLACK, "交叉路口", 64, 1);
    // Show_Str01(32, 120, RED, BLACK, "注意安全", 64, 1);
   Show_Str01(32, 56, RED, BLACK, "主路来车", 64, 1);
    Show_Str01(32, 120, RED, BLACK, "注意避让", 64, 1);
    delay_ms(1200);
}
...
void Pic_test(void)
{
    ...
    Show_Str(30 + 12, 75, BLUE, YELLOW, "DY", 16, 1);
    Gui_Drawbmp16(90, 30, gImage_qq);
    Show_Str(90 + 12, 75, BLUE, YELLOW, "DY", 16, 1);
    Gui_Drawbmp16(150, 30, gImage_qq);
    Show_Str(150 + 12, 75, BLUE, YELLOW, "DY", 16, 1);
    delay_ms(1200);
}
