...
//GPIO置位（拉高）
#define	LCD01_CS_SET  GPIO_TYPE_A->BSRR=1<<LCD_CS    //片选端口  	PA3
#define	LCD01_RS_SET	GPIO_TYPE_A->BSRR=1<<LCD_RS    //数据/命令  PA2 
#define	LCD01_RST_SET	GPIO_TYPE_A->BSRR=1<<LCD_RST   //复位			  PA4
...
//GPIO复位（拉低）
#define	LCD01_CS_CLR  GPIO_TYPE_A->BRR=1<<LCD_CS     //片选端口  	PA3
#define	LCD01_RS_CLR	GPIO_TYPE_A->BRR=1<<LCD_RS     //数据/命令  PA2
#define	LCD01_RST_CLR	GPIO_TYPE_A->BRR=1<<LCD_RST    //复位			  
